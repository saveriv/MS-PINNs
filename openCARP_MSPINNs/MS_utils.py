...
class system_dynamics():
    ...
    def __init__(self):
        ...
        self.tau_in = 0.3 # 0.3 in openCARP # 0.05 in Belhamadia et al
        self.tau_out = 5.0 # 5.0 in opencarp # 1 in Belhamadia et al
        self.tau_open = 120.0 # 120.0 in openCARP # 95 in Belhamadia et al
        self.tau_close = 150.0 # 150 in openCARP # 162 in Belhamadia et al
        self.D = 0.001
